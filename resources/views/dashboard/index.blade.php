    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2">
            <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <a class="font-semibold leading-normal text-sm group text-gray-600 dark:text-gray-300"
                    href="{{ route('kriteria') }}">
                    Mulai
                    <i
                        ...
                        <table id="tabel_data_matriks_penjumlahan"
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-400 font-semibold">Jumlah Kriteria
                                        <span class="font-normal">(n)</span>
                                    </td>
                        ...
                        <table id="tabel_data_matriks_penjumlahan"
                            ...
                            <tbody>
                                @php
                                    ...
                                    if ($jmlKriteria != 0 && $jmlKriteria - 1 != 0) {
                                        $lamdaMaks2 = $matriksPenjumlahanPrioritas->sum('prioritas') / $jmlKriteria;
                                        $CI2 = ($lamdaMaks2 - $jmlKriteria) / ($jmlKriteria - 1);
                                    } else {
                                        $lamdaMaks2 = 0;
